-- Complimentary workspaces have full access and are never billed. They join
-- paid Dodo plans in unlocking AI conversations beyond the included allowance.
...
begin
  ...
  select exists (
    ...
    where organization_id = p_organization_id
      and provider in ('dodo', 'complimentary')
      and status = 'active'
