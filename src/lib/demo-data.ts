...
export const knowledgeArticles = [
  { title: "Billing plans and annual discounts", collection: "Billing", status: "Healthy", used: 148, updated: "2 hours ago" },
  { title: "Configure SAML single sign-on", collection: "Security", status: "Needs review", used: 83, updated: "18 days ago" },
  { title: "Webhook retries and signatures", collection: "Developers", status: "Healthy", used: 71, updated: "Yesterday" },
  { title: "Data exports and deletion requests", collection: "Privacy", status: "Healthy", used: 54, updated: "4 days ago" },
  { title: "Invite and manage teammates", collection: "Getting started", status: "Gap detected", used: 39, updated: "26 days ago" },
];

export const automations = [
  { name: "Route enterprise billing", trigger: "Tag is Enterprise + topic is Billing", action: "Assign Finance desk · SLA 30m", runs: 142, saved: "11h", on: true },
  { name: "Resolve order status", trigger: "Intent is order_status + confidence > 90%", action: "Look up order · answer · close", runs: 618, saved: "44h", on: true },
  { name: "Escalate cancellation risk", trigger: "Sentiment frustrated + cancellation mentioned", action: "Assign senior agent · notify Slack", runs: 29, saved: "3h", on: true },
  { name: "Collect missing diagnostics", trigger: "Topic is technical + browser unknown", action: "Ask for browser and request ID", runs: 87, saved: "7h", on: false },
];

export const integrations = [
  { name: "Slack", category: "Collaboration", status: "Connected", color: "#e8c8ff", mark: "S" },
  { name: "Shopify", category: "Commerce", status: "Connected", color: "#c8ff73", mark: "S" },
  { name: "Linear", category: "Engineering", status: "Connected", color: "#cbd0ff", mark: "L" },
  { name: "Razorpay", category: "Billing", status: "Ready to configure", color: "#b9d8ff", mark: "R" },
  { name: "Salesforce", category: "CRM", status: "Available", color: "#bceeff", mark: "S" },
  { name: "HubSpot", category: "CRM", status: "Available", color: "#ffc1af", mark: "H" },
  { name: "Jira", category: "Engineering", status: "Available", color: "#cad8ff", mark: "J" },
  { name: "WhatsApp", category: "Messaging", status: "Coming next", color: "#bff2d0", mark: "W" },
];
